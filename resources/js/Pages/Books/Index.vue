   ...
   <AuthenticatedLayout>
      <template #header>
         <div class="flex items-center justify-between">
            ...
            <Alternative :url="route('books.create')">New Book</Alternative>
         </div>
      </template>
         ...
         <DataListLayout :footer="books.meta.last_page > 1">
               ...
               <table class="w-full text-md text-left text-gray-500 border-b dark:text-gray-400">
                  ...
                  <tbody>
                     ...
                     <tr v-if="books.data.length <= 0">
                        <td class="py-9 text-xl bg-white text-center font-bold" colspan="7">There is no book yet</td>
                     </tr>
                  </tbody>
               </table>
            </template>
            <template #footer>
               <div v-if="!mobile" class="font-semibold">
                  <p>Showing from {{ books.meta.from }} to {{ books.meta.to }} in total {{ books.meta.total }}
                     items</p>
               </div>
