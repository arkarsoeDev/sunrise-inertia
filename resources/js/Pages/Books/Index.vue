            ...
            <table class="w-full text-md text-left text-gray-500 border-b dark:text-gray-400">
               ...
               <tbody>
                  <tr v-for="member in members.data" :key="member.id"
                     ...
                     <td class="py-4 px-6">
                        <Link :href="route('members.edit',member.id)" class="font-medium mr-3 text-blue-600 dark:text-blue-500 hover:underline">Edit</Link>
                        <Link :href="route('members.destroy',member.id)" method="delete" class="font-medium text-red-600 dark:text-red-500 hover:underline">Delete
                        </Link>
                     </td>
                  </tr>
               </tbody>
