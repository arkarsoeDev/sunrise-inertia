   ...
   <AuthenticatedLayout>
      ...
      <template #header>
         <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Create New Book</h2>
      ...
      <div class="p-4 bg-white shadow rounded-lg">
         ...
         <form @submit.prevent="submit" class="max-w-md">
            ...
            <Input id="title" name="title" type="text" class="mb-6" v-model="form.title"
               placeholder="Title" :errorMessage="form.errors.title">Title</Input>
            <Input id="publication_date" name="publication_date" type="date" class="mb-6" v-model="form.publication_date"
               placeholder="Publication Date" :errorMessage="form.errors.publication_date">Publication Date</Input>
